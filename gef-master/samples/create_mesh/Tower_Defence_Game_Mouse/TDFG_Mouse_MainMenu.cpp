#include <Tower_Defence_Game_Mouse\TDFG_Mouse_MainMenu.h>
...
void TDFG_M_MAINMENUstate::init( gef::Platform* platform, ARSCalibrationData* ARSCalibration,
...
void TDFG_M_MAINMENUstate::InitMeshes()
{
...
void TDFG_M_MAINMENUstate::Render3DScene( gef::Renderer3D * renderer_3d_ )
{

}

void TDFG_M_MAINMENUstate::cleanup()
{
	delete platform_;
	platform_ = NULL;
}

void TDFG_M_MAINMENUstate::Update( StateManager* state_manager, float delta_time, gef::InputManager* input_manager_ )
{
...
void TDFG_M_MAINMENUstate::HandleInput( gef::InputManager* input_manager_ )
{
...
void TDFG_M_MAINMENUstate::HandleMouseInput( gef::InputManager* input_manager_ )
{
...
void TDFG_M_MAINMENUstate::Render( gef::Renderer3D * renderer_3d_, gef::SpriteRenderer * sprite_renderer_, gef::Font * font )
{
...
void TDFG_M_MAINMENUstate::DrawSprite( gef::SpriteRenderer * sprite_renderer_, gef::Font * font )
{
	font_ = font;
...
void TDFG_M_MAINMENUstate::DrawMesh( gef::Renderer3D * renderer_3d )
{
...
gef::Mesh* TDFG_M_MAINMENUstate::CreateSquare()
{
...
void TDFG_M_MAINMENUstate::InitFont()
{
	font_ = new gef::Font( *platform_ );
	font_->Load( "comic_sans" );
}

void TDFG_M_MAINMENUstate::CleanUpFont()
{
	delete font_;
	font_ = NULL;
}

void TDFG_M_MAINMENUstate::DrawHUD( gef::SpriteRenderer * sprite_renderer_ )
{
	if( font_ )
	{
		// display frame rate
